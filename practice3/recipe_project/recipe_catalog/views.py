...
from .constants import INDEX_TEMPLATE_NAME, RECIPE_TEMPLATE_NAME, ABOUT_TEMPLATE_NAME, REGISTER_TEMPLATE_NAME, \
    ...
    DELETE_INGREDIENT_TEMPLATE_NAME, EDIT_INGREDIENT_TEMPLATE_NAME, EDIT_INGREDIENT_FORM_TEMPLATE_NAME
from .forms import UserRegistrationForm, ReceiptForm, IngredientForm, ReceiptIngredientForm, RecipeIngredientsForm
